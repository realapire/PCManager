...
<head>
    ...
    <title>PCManager | Terms and Conditions</title>
    ...
    <style>
        ...
        .termsandconditions, .privacypolicy, .nda {
            margin:20px;
        }
...
<body style="background: url('images/background-image.png') center top / cover no-repeat;">
    ...
    <div class="termsandconditions">
        ...
        <p>Last updated: 2022-05-21</p>
        <p>1. <b>Introduction</b></p>
        <p>Welcome to <b>Apire Studios</b> (“Company”, “we”, “our”, “us”)!</p>
        <p>These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at <b>pcmanager.rf.gd</b> (together or individually “Service”) operated by <b>Apire Studios</b>.</p>
        <p>Our Privacy Policy also governs your use of our Service and explains how we collect, safeguard and disclose information that results from your use of our web pages.</p>
        <p>Your agreement with us includes these Terms and our Privacy Policy (“Agreements”). You acknowledge that you have read and understood Agreements, and agree to be bound of them.</p>
        <p>If you do not agree with (or cannot comply with) Agreements, then you may not use the Service, but please let us know by emailing at <b>apirestudios@email.com</b> so we can try to find a solution. These Terms apply to all visitors, users and others who wish to access or use Service.</p>
        <p>2. <b>Communications</b></p>
        <p>By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and other information we may send. However, you may opt out of receiving any, or all, of these communications from us by following the unsubscribe link or by emailing at apirestudios@email.com.</p>

        <p>3. <b>Contests, Sweepstakes and Promotions</b></p>
        <p>Any contests, sweepstakes or other promotions (collectively, “Promotions”) made available through Service may be governed by rules that are separate from these Terms of Service. If you participate in any Promotions, please review the applicable rules as well as our Privacy Policy. If the rules for a Promotion conflict with these Terms of Service, Promotion rules will apply.</p>


        <p>4. <b>Content</b></p><p>Our Service allows you to post, link, store, share and otherwise make available certain information, text, graphics, videos, or other material (“Content”). You are responsible for Content that you post on or through Service, including its legality, reliability, and appropriateness.</p><p>By posting Content on or through Service, You represent and warrant that: (i) Content is yours (you own it) and/or you have the right to use it and the right to grant us the rights and license as provided in these Terms, and (ii) that the posting of your Content on or through Service does not violate the privacy rights, publicity rights, copyrights, contract rights or any other rights of any person or entity. We reserve the right to terminate the account of anyone found to be infringing on a copyright.</p><p>You retain any and all of your rights to any Content you submit, post or display on or through Service and you are responsible for protecting those rights. We take no responsibility and assume no liability for Content you or any third party posts on or through Service. However, by posting Content using Service you grant us the right and license to use, modify, publicly perform, publicly display, reproduce, and distribute such Content on and through Service. You agree that this license includes the right for us to make your Content available to other users of Service, who may also use your Content subject to these Terms.</p><p>Apire Studios has the right but not the obligation to monitor and edit all Content provided by users.</p><p>In addition, Content found on or through this Service are the property of Apire Studios or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.</p>
        ...
        <p>Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Apire Studios and its licensors. Service is protected by copyright, trademark, and other laws of  and foreign countries. Our trademarks may not be used in connection with any product or service without the prior written consent of Apire Studios.</p>
        <p>10. <b>Copyright Policy</b></p>
        <p>We respect the intellectual property rights of others. It is our policy to respond to any claim that Content posted on Service infringes on the copyright or other intellectual property rights (“Infringement”) of any person or entity.</p>
        <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has been copied in a way that constitutes copyright infringement, please submit your claim via email to apirestudios@email.com, with the subject line: “Copyright Infringement” and include in your claim a detailed description of the alleged Infringement as detailed below, under “DMCA Notice and Procedure for Copyright Infringement Claims”</p>
        ...
        <p>You can contact our Copyright Agent via email at apirestudios@email.com.</p>
        <p>12. <b>Error Reporting and Feedback</b></p>
        <p>You may provide us either directly at apirestudios@email.com or via third party sites and tools with information and feedback concerning errors, suggestions for improvements, ideas, problems, complaints, and other matters related to our Service (“Feedback”). You acknowledge and agree that: (i) you shall not retain, acquire or assert any intellectual property right or other right, title or interest in or to the Feedback; (ii) Company may have development ideas similar to the Feedback; (iii) Feedback does not contain confidential information or proprietary information from you or any third party; and (iv) Company is not under any obligation of confidentiality with respect to the Feedback. In the event the transfer of the ownership to the Feedback is not possible due to applicable mandatory laws, you grant Company and its affiliates an exclusive, transferable, irrevocable, free-of-charge, sub-licensable, unlimited and perpetual right to use (including copy, modify, create derivative works, publish, distribute and commercialize) Feedback in any manner and for any purpose.</p>
        <p>13. <b>Links To Other Web Sites</b></p>
        <p>Our Service may contain links to third party web sites or services that are not owned or controlled by Apire Studios.</p>
        <p>Apire Studios has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.</p>
        ...
        <p>Please send your feedback, comments, requests for technical support by email: <b>apirestudios@email.com</b>.</p>
    </div>
   
    <div class="privacypolicy">
        <h2 style="text-align: center;"><b>PRIVACY POLICY</b></h2>
        <p>Effective date: 2022-05-21</p>
        <p>1. <b>Introduction</b></p>
        <p>Welcome to <b> Apire Studios</b>.</p>
        <p><b>Apire Studios</b> (“us”, “we”, or “our”) operates <b>pcmanager.rf.gd</b> (hereinafter referred to as <b>“Service”</b>).</p>
        <p>Our Privacy Policy governs your visit to <b>pcmanager.rf.gd</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
        ...
        <p><b>SERVICE</b> means the pcmanager.rf.gd website operated by Apire Studios.</p>
        ...
        <p>Apire Studios uses the collected data for various purposes:</p>
        ...
        <p>Apire Studios will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
        ...
        <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>apirestudios@email.com</b>.</p>
        ...
        <p>0.4. users are able to change their personal information by emailing us at <b>apirestudios@email.com</b>.</p>
        ...
        <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>apirestudios@email.com</b>.</p>
        ...
        <p>If you have any questions about this Privacy Policy, please contact us by email: <b>apirestudios@email.com</b>.</p>

    </div>

    <div class="nda">

        <h2 style="text-align: center;"><b>NON-DISCLOSURE AGREEMENT</b></h2>
        <p>This non-disclosure agreement <b>(“agreement”)</b> is made on <b>2022-05-21</b>, between <b>Apire Studios (“Company”)</b> and the other party named on the signature page below <b>(“Other Party”)</b> to protect certain confidential information being disclosed between Company and the Other Party solely for the purpose of <b>technical audit (“Purpose”)</b>. Company and Other Party may be referred to in this agreement individually as a <b>“party”</b> and collectively as <b>“parties”</b>.</p>
        <p><b><u>1. Confidential Information. “Confidential Information” means the proprietary information exchanged between parties, which includes, without limitation, information (tangible or intangible) regarding a party’s technology, software code, software source documents, techniques, research, know-how, specifications, product plans, pricing, customer information, user data, current or future strategic information, current or future business plans, policies or practices, employee information, and other business and technical information, which is (i) marked “confidential” or “proprietary” at the time of disclosure by party disclosing it; or (ii) by its nature or content is reasonably distinguishable as confidential or proprietary to party receiving Confidential Information.</u></b></p>

        <p><b><u>2. Mutual obligations. Each party discloses its Confidential Information to the other under this agreement. “Discloser” will mean party disclosing Confidential Information and “Recipient” will mean party receiving Confidential Information from Discloser. Each of parties is a Discloser in respect of Confidential Information owned by such party.</u></b></p>
        <p><b><u>3. Nondisclosure of Confidential Information. Subject to clause 4 (Permitted disclosure), each party agrees to hold Confidential Information in confidence and to not use or disclose it to a third party for a period of 1 year from the date of initial disclosure of Confidential Information, and will use Confidential Information of Discloser only for Purpose. Recipient will also protect such Confidential Information with at least the same degree of care that Recipient uses to protect its own Confidential Information, but in no case, less than reasonable care (including reasonable security measures) to prevent the unauthorized use, dissemination or publication of Confidential Information.</u></b></p>
        <p>Recipient must promptly notify Discloser of any misuse, misappropriation or unauthorized disclosure of Confidential Information of Discloser which may come to Recipient’s attention.</p>
        <p>Recipient may disclose Confidential Information to its employees, agents, financial advisers and independent contractors with a need-to-know, only as necessary to fulfil Purpose and provided such parties have signed confidentiality agreements containing, or are otherwise bound by, confidentiality obligations at least as restrictive as those contained in this agreement.</p>
        <p><b><u>4. Permitted disclosure. Information disclosed under this agreement will not be considered Confidential Information, if Recipient can prove that such information:</u></b></p>
        <p>4.1. was in the public domain prior to the time of disclosure or has entered the public domain through no fault of Recipient;</p>
        <p>4.2. was known to Recipient, without restriction, at time of disclosure;</p>
        <p>4.3. was independently developed by Recipient without use of or reference to Confidential Information;</p>
        <p>4.4. is rightfully disclosed to Recipient by a third party without confidentiality restrictions;</p>
        <p>4.5. is disclosed with the prior written approval of Discloser; or</p>
        <p>4.6. is disclosed pursuant to the order or requirement of a court, administrative agency, or other governmental body; provided, however, that Recipient will (i) notify Discloser in writing of the requirement for disclosure, unless notice is prohibited by law; and (ii) disclose only that portion of Confidential Information legally required.</p>
        <p><b><u>5. Return of information. Upon request of Discloser, Recipient will promptly return or certify the destruction of Confidential Information and all authorized copies thereof.</u></b></p>
        <p><b><u>6. No rights to Confidential Information granted. Each party will retain all right, title and interest to its Confidential Information. This agreement does not grant to either party patent, copyright or other intellectual property right that has issued or that may issue, based on Confidential Information or other rights, except the limited right to use Confidential Information for Purpose.</u></b></p>
        <p>Nothing in this agreement creates or will be deemed to create any employment, joint venture, or agency between Parties.</p>
        <p>Nothing in this agreement requires Discloser to enter into any transaction with Recipient in connection with which Confidential Information may be disclosed.</p>
        <p><b><u>7. No reverse engineering. Other Party will not modify, reverse engineer, decompile, reproduce, create other works from or disassemble any software programs contained in Confidential Information of Company. Any reproduction by Other Party of any Confidential Information of Company will remain the property of Company.</u></b></p>
        <p><b><u>8. No warranty. All Confidential Information is provided “as is” for use by Other Party at its own risk. Company disclaims any warranties, express, implied, statutory or otherwise, regarding Confidential Information, including without limitation, any warranties of title, merchantability, fitness for a particular purpose or non-infringement.</u></b></p>
        <p><b><u>9. No Publicity. Neither party will, without the prior consent of the other party, disclose to any person the fact that Confidential Information of Discloser has been or may be disclosed under this agreement, that discussions or negotiations are taking place between parties, or any of the terms, conditions, status or other facts with respect to this agreement, except as required by law.</u></b></p>
        <p><b><u>10. Term. This agreement will terminate 1 year after the date of this agreement, or may be terminated by either party at any time upon thirty (30) days written notice to other party. Each Party’s obligations under this agreement will survive termination of this agreement and will be binding upon such party’s heirs, successors, and assigns.</u></b></p>
        <p><b><u>11. Remedies. Recipient agrees that due to the unique nature of Discloser’s Confidential Information any breach of this agreement may result in irreparable damage to Discloser for which monetary damages would be an inadequate remedy. Therefore, in addition to any other remedies that may be available, in law, in equity or otherwise, Discloser will be entitled to obtain injunctive relief against the threatened breach of this agreement or the continuation of any such breach by Recipient.</u></b></p>
        <p><b><u>12. Governing law. This agreement will be governed by the laws of Belgium, without giving effect to principles of conflicts of law.</u></b></p>
        <p><b><u>13. Final provisions.</u></b></p>
        <p>13.1. This agreement constitutes the entire agreement between parties with respect to its subject matter and supersedes all prior agreements between parties regarding the same subject matter.</p>
        <p>13.2. This agreement can be modified only by a written amendment signed by parties.</p>
        <p>13.3. Failure to enforce any provisions of this agreement will not constitute a waiver.</p>
        <p>13.4. If any provision is unenforceable, the other provisions will remain effective.</p>
        <p>13.5. Parties may execute this agreement in counterparts, which taken together will constitute one instrument.</p>
        <p>13.6. Neither party may assign or transfer this agreement without the prior written consent of the other party.</p>
        <p>13.7. Any notice under this agreement must be in writing and delivered personally or by overnight courier or sent by email.</p>
